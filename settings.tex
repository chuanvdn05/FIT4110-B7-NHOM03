...
\titlespacing*{\section}
{0pt}      % lề trái
{12pt}     % khoảng cách phía trên
{6pt}      % khoảng cách phía dưới
...
\newcommand{\TenSinhVien}{NGUYỄN XUÂN ANH; VŨ ĐỨC NGUYỄN CHUẨN; TĂNG TẤT CƯƠNG}
\newcommand{\MaSinhVien}{1771020004; 1771020104; 1771020111}
\newcommand{\KhoaHoc}{2023 -- 2027}

\newcommand{\TenBaoCao}{XÂY DỰNG NOTIFICATION SERVICE CHO HỆ THỐNG SMART CAMPUS OPERATIONS PLATFORM}
\newcommand{\LoaiBaoCao}{BÁO CÁO BÀI TẬP LỚN}
\newcommand{\Nganh}{CÔNG NGHỆ THÔNG TIN}
\newcommand{\ChuyenNganh}{DỊCH VỤ KẾT NỐI VÀ CÔNG NGHỆ NỀN TẢNG}
